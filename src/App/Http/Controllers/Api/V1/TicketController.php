...
namespace Callmeaf\Ticket\App\Http\Controllers\Api\V1;
...
class TicketController extends ApiController implements HasMiddleware
{
    ...
    {
        return $this->ticketRepo->builder(fn(Builder $query) => $query->fromSender($this->request->user()->email))->latest()->search()->paginate();
    }
